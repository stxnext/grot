...
(function() {
  var Board, Field, FieldWidget, Game, Level, Renderer, TWEEN_DURATION, TopBarWidget, randomChoice,
  ...
  Renderer = (function() {
    ...
    function Renderer(board, level) {
      ...
      this.layer.add(this.topBarWidget.group);
    ...
    Renderer.prototype.finishMove = function() {
      ...
      if (this.moveLength > this.board.size + 1) {
        this.level.movesDiff = Math.round((this.moveLength - this.board.size) / 2);
