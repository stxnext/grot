...
(function() {
  var Board, Field, FieldWidget, Game, Level, QueryString, Renderer, TWEEN_DURATION, TopBarWidget, delay1s, randomChoice,
  ...
  Renderer = (function() {
    ...
    Renderer.prototype.finishMove = function() {
      ...
      if (this.moveLength >= Math.round(1.5 * this.board.size)) {
        this.level.movesDiff = (this.moveLength + 1) - Math.round(1.5 * this.board.size);
